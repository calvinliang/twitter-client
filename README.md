...
<img src='http://i.imgur.com/eRWRG2l.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I had a lot of trouble with the tab library. The video walkthrough and the codepath cliffnotes are not the same, so I spent a lot of time figuring out the dependency differences.
